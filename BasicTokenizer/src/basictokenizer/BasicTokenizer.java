...
/*
 * File: BasicTokenizer.java. Renamed from Sun's StringTokenizer.java
 * to provide a class for software testing exercises.
 *   - N. Wilde
 *
 ...
 * @since   JDK1.0
 */
public class BasicTokenizer implements Enumeration<Object> {
     ...
     */
    public BasicTokenizer(String str, String delim, boolean returnDelims) {
    currentPosition = 0;
    newPosition = -1;
    delimsChanged = false;
    this.str = str;
     ...
     * @exception NullPointerException if str is <CODE>null</CODE>
     */
    public BasicTokenizer(String str, String delim) {
